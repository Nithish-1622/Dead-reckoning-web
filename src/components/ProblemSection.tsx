...
export const ProblemSection: React.FC = () => {
  ...
  return (
    <section id="problem" className="min-h-[calc(100vh-4.5rem)] flex flex-col justify-center py-10 sm:py-14 bg-neutral-100 dark:bg-[#070709] border-t border-neutral-200 dark:border-neutral-800 transition-colors relative scroll-mt-16">
