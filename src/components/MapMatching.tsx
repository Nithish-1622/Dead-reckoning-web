...
export const MapMatching: React.FC = () => {
  ...
  return (
    <section className="min-h-[calc(100vh-4.5rem)] flex flex-col justify-center py-10 sm:py-14 bg-white dark:bg-black border-t border-neutral-200 dark:border-neutral-800 transition-colors relative scroll-mt-16">
